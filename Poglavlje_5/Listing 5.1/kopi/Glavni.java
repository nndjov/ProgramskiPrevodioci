...
public class Glavni extends JPanel{
	...
	Glavni(){
        ...
        /////////////////////
           ...
           tabela.setToolTipText("Tabela simbola");
        /////////////////////
           JButton parser = new JButton("Parser");
           //start.setRolloverIcon(new ImageIcon(getClass().getResource("/slike/start1.png")));
           parser.addActionListener( new ActionListener() {
                public void actionPerformed(ActionEvent e){
					String tekst = monitorT.getText() + "\nPARSIRANJE";
					tekst = tekst + "\n-------------------\n";
					Skener skener = new Skener(ulazT.getText());
					p = new Parser(skener);
                    p.parsiranje();
                    tekst = tekst + p.parser()+"\n\n";
					tekst = tekst +REZULTAT+"\n";
					monitorT.setText(tekst);
                }
		   }
           );
           ulazPaleta.add(parser);
           parser.setToolTipText("Parser");
        /////////////////////
           JButton stablo = new JButton("Stablo");
           //start.setRolloverIcon(new ImageIcon(getClass().getResource("/slike/start1.png")));
           stablo.addActionListener( new ActionListener() {
                public void actionPerformed(ActionEvent e){
					monitorT.setText(p.stablo()+"\n");
                }
		   }
           );
           ulazPaleta.add(stablo);
           stablo.setToolTipText("RUN");
        /////////////////////
           JButton eval = new JButton("Evaluacija");
           //start.setRolloverIcon(new ImageIcon(getClass().getResource("/slike/start1.png")));
           eval.addActionListener( new ActionListener() {
                public void actionPerformed(ActionEvent e){
					REZULTAT_="";
					//Skener skener = new Skener(ulazT.getText());
					Parser1 p = new Parser1(k);
                    p.parsiranje();
					monitorT.setText(REZULTAT_+"\n");
                }
		   }
           );
           ulazPaleta.add(eval);
           eval.setToolTipText("RUN");

        /////////////////////
           JButton sin = new JButton("Sintaksno stablo");
           //start.setRolloverIcon(new ImageIcon(getClass().getResource("/slike/start1.png")));
           sin.addActionListener( new ActionListener() {
                public void actionPerformed(ActionEvent e){
					//Skener skener = new Skener(ulazT.getText());
					Parser2 p = new Parser2(k);
                    p.parsiranje();
                }
		   }
           );
           ulazPaleta.add(sin);
           sin.setToolTipText("RUN");
        /////////////////////
		...
		ulazT.setText(procitajDatoteku("ulaz.txt"));
		ulazFile = new File("ulaz.txt");
